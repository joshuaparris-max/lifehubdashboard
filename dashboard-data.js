...
window.LIFEHUB_DATA.cards = [
  {
    ...
    links: [{ label: "Open Inbox", href: "Inbox/index.html", note: "Review & file everything" }],
    tags: ["weekly", "triage"],
  ...
  },
  {
    ...
    links: [
      { label: "Career files & contracts", href: "Work/Career/index.html" },
      { label: "Job search material", href: "Work/Job_Search/index.html" },
      { label: "Professional development", href: "Work/Professional_Development/index.html" },
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Health & medical", href: "Family/Health/index.html" },
      { label: "Education & therapy resources", href: "Family/Education/index.html" },
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Insurance documents", href: "Finance/Insurance/index.html" },
      { label: "Invoices & receipts", href: "Finance/Invoices/index.html", note: "Speechworks, reimbursements" },
      { label: "Statements & summaries", href: "Finance/Statements/index.html" },
    ],
    tags: ["money", "admin"],
  ...
  },
  {
    ...
    links: [{ label: "Property folder", href: "Housing/Property/index.html" }],
  ...
  },
  {
    ...
    links: [
      { label: "Admin & identity", href: "Personal/Admin/index.html" },
      { label: "Planning & travel", href: "Personal/Planning/index.html" },
      { label: "Wellbeing & biometrics", href: "Personal/Health/index.html" },
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Projects/Software", href: "Projects/Software/index.html" },
      { label: "Tools & SDKs", href: "Projects/Software/Tools/index.html" },
    ],
    tags: ["code", "builds"],
  ...
  },
  {
    ...
    links: [
      { label: "Gaming", href: "Hobbies/Gaming/index.html" },
      { label: "Modding utilities", href: "Hobbies/Gaming/Modding/index.html" },
      { label: "Tabletop & D&D", href: "Hobbies/Tabletop/index.html" },
    ],
  ...
  },
  {
    ...
    links: [
      { label: "Photos", href: "Media/Photos/index.html" },
      { label: "Screenshots", href: "Media/Screenshots/index.html" },
    ],
  ...
  },
  {
    ...
    links: [{ label: "Browse Archive", href: "Archive/index.html" }],
